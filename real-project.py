...
while True:
    ...
    pygame.draw.rect(screen, white, (70, 35, 1095, 10))
    pygame.draw.rect(screen, white, (1155, 35, 10, 595))
    pygame.draw.rect(screen, white, (665, 620, 500, 10))
    pygame.draw.rect(screen, white, (630, 70, 10, 525))
    pygame.draw.rect(screen, white, (665, 70, 10, 525))
    pygame.draw.rect(screen, white, (700, 70, 10, 525))
    pygame.draw.rect(screen, white, (735, 70, 10, 525))
    pygame.draw.rect(screen, white, (770, 70, 10, 525))
    pygame.draw.rect(screen, white, (805, 70, 10, 525))
    pygame.draw.rect(screen, white, (840, 70, 10, 525))
    pygame.draw.rect(screen, white, (875, 70, 10, 525))
    pygame.draw.rect(screen, white, (910, 70, 10, 525))
    pygame.draw.rect(screen, white, (910, 70, 220, 10))
    pygame.draw.rect(screen, white, (1120, 70, 10, 525))
    pygame.draw.rect(screen, white, (910, 585, 220, 10))
    ...
    pygame.draw.rect(screen, blue, (205, 320, 65, 10))
    pygame.draw.rect(screen, blue, (170, 355, 100, 10))
    ...
    pygame.draw.rect(screen, yellow, pygame.Rect(x, y, 25, 25))
